...
# Inputs:   clean-data/vis2.Rda
# Outputs:  plots/yyyy-mm-dd-chronic-conditions-2001-2022.png
# Author:   Mark Hanly
###############################################################
...
ggplot(
  ...
  geom_richtext( # Label lines (geom_richtext allows for formmatting)
    data = df2Plot |>
      group_by(condition) |>
...
ggsave(filename = paste0('plots/', Sys.Date(),"-chronic-conditions-2001-2022.png"),
       width = 6,
       height = 4,
       units = 'in')
