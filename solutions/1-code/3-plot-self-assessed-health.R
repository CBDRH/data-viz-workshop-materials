...
# Inputs:   solutions/3-clean-data/vis1.Rda
# Outputs:  solutions/4-outputs/yyyy-mm-dd-self-assessed-health.png
# Author:   Mark Hanly
###############################################################
...
# Load cleaned data
load('solutions/3-clean-data/vis1.Rda')
...
ggplot() +
  ...
  labs(
    ...
    subtitle = 'Self-assessed health status by states and territories (age standrdised)',
...
ggsave(filename = paste0('solutions/4-outputs/', Sys.Date(),"-self-assessed-health.png"),
       width = 6,
       height = 4,
       units = 'in')
